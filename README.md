<p align="center">
  <img src="Pics/Newton's_Annotated_copy_of_his_Principia_Mathematica.jpg" width="340" title="hover text">
...
Este curso de mecánica es de nivel intermedio/avanzado y se dicta como una cadena en dos  
períodos (trimestes) académicos.

Se espera que el estudiante que toma este curso conozca el material correspondientes al texto de mecánica de [Berkeley](https://en.wikipedia.org/wiki/Berkeley_Physics_Course) o del libro de French de mecánica newtoniana. 
...
Como parte del curso el estudiante entrará en contacto el lenguaje de programación [Python](https://www.python.org/) sus bibliotecas con el fin de resolver algunos problemas de mecánica, con este fin haremos énfasis en trabajar con cuadernos [jupyter](https://jupyter.org/) en el ambiente [Google Colab](https://colab.research.google.com/?utm_source=scs-index).
